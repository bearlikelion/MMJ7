...
func _ready():
	...
	# load banks
	Fmod.bank_load("./src/_personal/RinatSatyl/fmod_test//Master.bank", Fmod.FMOD_STUDIO_LOAD_BANK_NORMAL)
	Fmod.bank_load("./src/_personal/RinatSatyl/fmod_test//Master.strings.bank", Fmod.FMOD_STUDIO_LOAD_BANK_NORMAL)
